...
export default function TradeFeaturesSection({ tradeData }) {
  const { trade, features } = tradeData
  ...
  const defaultFeatures = [
    {
      ...
      description: `Personalised websites reflecting your ${trade.toLowerCase()} business's unique personality and brand.`
    },
    {
      icon: Smartphone,
        ...
        <div className="max-w-6xl mx-auto">
          <FadeInUp className="text-center space-y-6 mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
              Stand Out Online as a {trade.slice(0, -1)}
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              In today's digital world, your online presence is paramount. We craft bespoke websites tailored specifically for {trade.toLowerCase()}.
            </p>
          </FadeInUp>
          ...
          <ScaleIn delay={0.8}>
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900">
                Ready to grow your {trade.toLowerCase()} business?
              </h3>
